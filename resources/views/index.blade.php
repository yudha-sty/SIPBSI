                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                   ...
                                   <h1 class="h3 mb-0 text-gray-800">Visi :</h1>
                                   TOP 10 GLOBAL ISLAMIC BANK <br>
<br>
                                   <h1 class="h3 mb-0 text-gray-800">MISI:</h1>
                                   <p class="h5 mb-0 text-gray-800">1. Memberikan akses solusi keuangan syariah di Indonesia</p>
                                Melayani >20 juta nasabah dan menjadi top 5 bank berdasarkan asset (500+T) dan nilai buku 50 T di tahun 2025.<br>
                                <p class="h5 mb-0 text-gray-800">2. Menjadi bank besar yang memberikan nilai terbaik bagi para pemegang saham </p>
                                Top 5 bank yang paling profitable di Indonesia (ROE 18%) dan valuasi kuat (PB>2). <br>
                                <p class="h5 mb-0 text-gray-800">3. Menjadi perusahaan pilihan dan kebanggaan para talenta terbaik Indonesia</p>
